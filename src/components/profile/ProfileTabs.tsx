    ...
    <div className="bg-white min-h-screen">
      <div className="w-full max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
        <Tabs value={activeTab} onValueChange={handleTabChange} className="w-full">
          {/* Two-Tab Navigation */}
          <div className="border-b border-[#E5E7EB] mb-4 md:mb-6">
            <TabsList className="grid w-full grid-cols-2 bg-transparent h-auto p-0 gap-0">
              <TabsTrigger 
                value="posts" 
                className="relative py-3 md:py-4 px-4 md:px-6 text-sm font-semibold rounded-none border-b-2 border-transparent transition-all duration-200 data-[state=active]:border-primary data-[state=active]:text-primary data-[state=inactive]:text-gray-500 data-[state=inactive]:hover:text-[#111827] hover:bg-gray-50/50"
              >
                Posts
              </TabsTrigger>
              <TabsTrigger 
          ...
          <div className="pb-6 md:pb-8">
            ...
            <TabsContent value={secondTabValue} className="space-y-4 md:space-y-6 m-0">
