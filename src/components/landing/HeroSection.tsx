...
const HeroSection = () => {
  ...
  return (
      ...
      <div className="absolute inset-0 z-0 opacity-[0.03] pointer-events-none [mask-image:radial-gradient(ellipse_at_center,white,transparent)]">
        <div className="h-full w-full bg-[grid-line:black_1px] bg-[size:40px_40px]"></div>
      </div>
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        <h1 className="text-6xl md:text-8xl font-extrabold text-gray-900 tracking-tight mb-8">
          Connecting creativity
          <span className="block text-blue-500">with Opportunity</span>
        </h1>
        ...
        <div className="flex flex-wrap justify-center gap-6">
          ...
          <div className="relative transition-transform duration-300 hover:scale-105 opacity-80">
            <img
              src="https://developer.apple.com/assets/elements/badges/download-on-the-app-store.svg"
              alt="Download on the App Store"
              className="h-14 md:h-16 object-contain grayscale"
            />

            <span className="absolute -top-6 -right-5 bg-blue-600 text-white text-[10px] px-2 py-[3px] rounded-full shadow-md">
              Coming Soon
            </span>
          </div>
