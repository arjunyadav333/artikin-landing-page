...
-- Create unique constraint for daily profile views
CREATE UNIQUE INDEX IF NOT EXISTS idx_unique_daily_profile_view 
...
DROP TRIGGER IF EXISTS portfolio_count_trigger ON public.portfolios;
CREATE TRIGGER portfolio_count_trigger
