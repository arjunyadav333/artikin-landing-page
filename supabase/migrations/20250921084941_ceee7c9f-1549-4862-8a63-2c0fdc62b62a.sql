...
-- Create debounced function to mark messages as seen (prevents duplicate calls)
CREATE OR REPLACE FUNCTION mark_message_seen_debounced(message_id_param uuid)
RETURNS boolean
LANGUAGE plpgsql
SECURITY DEFINER
SET search_path = public
