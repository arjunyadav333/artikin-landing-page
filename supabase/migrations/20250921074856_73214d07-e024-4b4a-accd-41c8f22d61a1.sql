-- Fix the create_or_get_conversation function to handle existing participants properly
...
BEGIN
  ...
  -- Create participant records for both users - using INSERT ... ON CONFLICT to avoid duplicates
