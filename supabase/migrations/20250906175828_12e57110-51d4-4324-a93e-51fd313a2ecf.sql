-- Update the secure views to include all necessary fields that were in the original views

-- Drop and recreate the posts view with all required fields
...
-- Update the conversations view to include message details
...
GRANT SELECT ON public.posts_with_profiles_secure TO authenticated, anon;
GRANT SELECT ON public.conversations_secure TO authenticated, anon;